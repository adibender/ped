...
#' \code{ped} package. Two main applications must be distinguished:
#' \enumerate{
...
#' See the \href{https://adibender.github.io/ped//articles/data-transformation.html}{data-transformation}
...
#' @rdname as_ped
#' @importFrom purrr as_vector imap
#' @export
